 ...
 * Added the SdFat library to the project folder. Apparently it requires an old version so since the library is GPL I've included it here. Copy the folder to your Arduino libraries path.
